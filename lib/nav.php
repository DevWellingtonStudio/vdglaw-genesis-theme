...
function bfg_nav_menu_markup_filter( $html, $args ) {
    ...
    $output .= '<button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#'.$data_target.'" aria-controls="'.$data_target.'" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"><i class="fa-2x fas fa-bars"></i></span></button>';
    $output .= $html;
