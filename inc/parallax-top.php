...
function add_parallax_front_page() {
	...
	$parallax_button_link = get_theme_mod('parallax_button_link');
		...
		echo '<div id="fp-parallax-top" class="parallax-window">
					...
					<img src="' . $parallax_bg_img . '" style="width:100%;" srcset="/img/hero-576x314.png 39vw, /img/hero-768x418.png 52vw, /img/hero-991x540.png 72vw, /img/hero-1200x654.png 87vw" sizes="100vw">
